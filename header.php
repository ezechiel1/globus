...
<head>
    <meta charset="utf-8">
    <title>Globus~E-Commerce | Universal E-Commerce
    </title>
    <!-- SEO Meta Tags-->
            ...
            <ul class="offcanvas-submenu">
              ...
              if(!empty($allSubCategory)):
                  ...
                  foreach($allSubCategory as $showSubCategory): 
                      $count++; 
              ?>
                  <li><a href="views/shop-product.php?SubCategory=<?php echo urlencode(trim($showSubCategory['subCategory_name']))?>&ct=<?php echo $showCategory['categoryID'];?>&sct=<?php echo $showSubCategory['subCategoryID'];?>"><?php echo $showSubCategory['subCategory_name'];?></a></li>
              <?php
                  endforeach;
              else: ?><li><a href="views/shop-product.php?Category=<?php echo urlencode(trim($showCategory['category_name']))?>&ct=<?php echo $showCategory['categoryID'];?>"><?php echo $showCategory['category_name'];?></a></li>
              <?php
              endif;
              ?>
            </ul>
...
?>
    ...
    <div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.php">
        <div class="user-ava"><img src="img/account/user-ava-md.jpg" alt="Ns. Olivier">
        </div>
        <div class="user-info">
          <h6 class="user-name">Ns. Olivier</h6><span class="text-sm text-white opacity-60">290 Reward points</span>
        </div></a>
      <nav class="offcanvas-menu">
        <ul class="menu">
          <?php
...
?>
          ...
          <li><a href="views/shop-grid-ns.php"><span>Shop</span></a>
            <!-- <ul class="sub-menu">
...
-->
          <li><a href="views/views/account-orders.php"><span>Account</span></a>
            <ul class="sub-menu">
                <li><a href="views/account-login.php">Login / Register</a></li>
                <li><a href="views/account-password-recovery.php">Password Recovery</a></li>
                <li><a href="views/account-orders.php">Orders List</a></li>
                <li><a href="views/account-wishlist.php">Wishlist</a></li>
                <li><a href="views/account-profile.php">Profile Page</a></li>
                <li><a href="views/account-address.php">Contact / Shipping Address</a></li>
                <li><a href="views/account-tickets.php">My Tickets</a></li>
                <li><a href="views/account-single-ticket.php">Single Ticket</a></li>
            </ul>
          </li>
          <li><a href="blog-rs.php"><span>Media</span></a>
            <ul class="sub-menu">
              <li class="has-children"><a href="views/blog-rs.php"><span>Blog Layout</span></a>
                <ul class="sub-menu">
                    <li><a href="views/blog-rs.php">Blog Right Sidebar</a></li>
                    <li><a href="views/blog-ls.php">Blog Left Sidebar</a></li>
                    <li><a href="views/blog-ns.php">Blog No Sidebar</a></li>
                </ul>
              </li>
          ...
          <li><a href="views/about.php"><span>About Us</span></a>
<!--
            <ul class="sub-menu">
...
-->
          ...
          <li><a href="views/contacts.php"><span>Contacts</span></a>
<!--
            <ul class="sub-menu">
                <li><a href="about.php">About Us</a></li>
                <li><a href="contacts.php">Contacts</a></li>
