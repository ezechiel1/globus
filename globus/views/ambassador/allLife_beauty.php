                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd"><br class="hidden-xs hidden-sm"><br class="hidden-xs hidden-sm">
                                <div class="main-sparkline13-hd">
                                    <h1>Suppliers <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="POST" action="../../class/Supplier_Controller.php" class="form-group" style="shape-margin: 20px;">
