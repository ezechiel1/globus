                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd"><br class="hidden-xs hidden-sm"><br class="hidden-xs hidden-sm">
                                <div class="main-sparkline13-hd">
                                    <h1>All<span class="table-project-n">Client</span>
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo $show['client_country'];?></td>
                                                <td><?php if($show['client_status']==0) echo 'Desactivated'; else echo 'Activated';?></td>
                                                <td>
          ...
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="post" action="" class="form-group" style="shape-margin: 20px;">
               ...
               <div class="form-group">
                  <input type="text" name="address" value="<?php echo $show['admin_location'];?>" class="form-control col-xs-6">
              </div><br><br>
              <div class="form-group">
