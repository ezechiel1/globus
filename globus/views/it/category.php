...
?>
 ...
 <div class="blog-area mg-tb-15" style="padding-top: 30px !important;padding-bottom:  30px !important;">
            <div class="container-fluid">
                <div class="row">
                  <span class="col-md-12"><a href="" class="btn btn-xs btn-primary fa fa-plus" data-toggle="modal" <?php  echo 'data-target="#newCategory"'; ?> > New Category</a><small><strong  class="pull-right text-success">
                                        <?php
                                            $sessData=array();
                            ...
                            <div class="panel-heading custom-blog-hd">
                                <div class="media clearfix">
                                    <a class="pull-left" href="subcategory.php?Category=<?php echo $show['category_name']?>&ct=<?php echo $show['categoryID'];?>">
											<img class="img-circle" style="width: 76px; height: 76px;" src="<?php echo $show['category_picture1'];?>" alt="profile-picture">
										</a>
...
<div class="modal fade"  <?php  echo 'id="newCategory"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form enctype="multipart/form-data" method="post" action="../../class/CategoryController.php" class="form-group" style="shape-margin: 20px;">
               <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Logo_1</label>
                                                            </div>
                                                            <div class="input-group" style="margin-top: 15px !important;  ">
                                                                ...
                                                                <input type="file" required="" class="form-control" placeholder="" name="product_picture1">
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Logo_2</label>
                                                            </div>
                                                            <div class="input-group" style="margin-top: 15px !important;  ">
                                                                <span class="input-group-addon"><i class="fa fa-image" aria-hidden="true"></i></span>
                                                                <input type="file" required="" class="form-control" placeholder="" name="product_picture2">
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Logo_3</label>
                                                            </div>
                                                            <div class="input-group" style="margin-top: 15px !important;  ">
                                                                <span class="input-group-addon"><i class="fa fa-image" aria-hidden="true"></i></span>
                                                                <input type="file" required="" class="form-control" placeholder="" name="product_picture3">
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="addCategory">Register</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
