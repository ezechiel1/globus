...
?>
                                            <tr>
                                                ...
                                                <td>
                            <a href="" class="glyphicon glyphicon-pencil text-primary" data-toggle="modal" <?php  echo 'data-target="#edit'.$show['supplierID'].'ers"'; ?>></a>  
                             <a href="" class="glyphicon glyphicon-remove text-danger" data-toggle="modal" <?php  echo 'data-target="#remove'.$show['supplierID'].'ers"'; ?>></a>
                             <a href="" class="btn btn-danger btn-xs text-danger" data-toggle="modal" <?php  echo 'data-target="#reset'.$show['supplierID'].'ers"'; ?>>Reset</a>
                          </td>
                                            </tr>

<!--Code for the Modals-->
<div class="modal fade"  <?php  echo 'id="remove'.$show['supplierID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header"><p class="modal-title" id="exampleModalLabel">Globus~System <span class="text-muted"> | Deletion of Supplier Account</span></p></div>
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="POST" action="../../class/SupplierController.php" class="form-group" style="shape-margin: 20px;">
                <center><label>Do you want to Delete this Supplier: <?php echo $show['supplier_fname'].' '.$show['supplier_lname'];?>?</label><br>
    ...
    <div class="modal fade"  <?php  echo 'id="reset'.$show['supplierID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
    ...
    <!--edit the selected field-->
     ...
     <div class="modal fade"  <?php  echo 'id="edit'.$show['supplierID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="post" action="../../class/SupplierController.php" class="form-group" style="shape-margin: 20px;">
                ...
                <div class="form-group">
                  <input type="text" name="Fname" value="<?php echo $show['supplier_fname'];?>" class="form-control col-xs-6">
                </div><br><br><br>
                <div class="form-group">
                  <input type="text" name="Lname" value="<?php echo $show['supplier_lname'];?>" class="form-control col-xs-6">
                </div><br><br>
                <div class="form-group">
                  <input type="email" name="Email" value="<?php echo $show['supplier_email'];?>" class="form-control col-xs-6">
                </div><br><br>
                <div class="form-group">
              ...
              <div class="form-group">
                  <select  name="Status"  class="form-control col-xs-6">
                    <option hidden="" value="<?php echo $show['status_status'];?>"><?php if($show['supplier_status']==0) echo 'Desactivated'; else if($show['supplier_status']==1) echo 'Activated';?></option>
                    <option value="1">Activate</option>
                    <option value="0">Desactivate</option>
                  </select>
              </div><br><br>
                <input type="text" hidden="" value="<?php echo $show['supplierID'];?>" name="updateform">
                <button class="btn btn-secondary btn-default" type="button" data-dismiss="modal">Cancel</button>
