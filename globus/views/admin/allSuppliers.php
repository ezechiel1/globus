                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd"><br class="hidden-xs hidden-sm"><br class="hidden-xs hidden-sm">
                                <div class="main-sparkline13-hd">
                                    <h1>All<span class="table-project-n">Suppliers</span><small><strong class="pull-right text-success"><?php
                                    $sssData=array();
                                    ...
                                    <table class="table table-striped table-bordered" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="comapany" data-editable="true">Company</th>
          ...
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="POST" action="../../class/SupplierController.php" class="form-group" style="shape-margin: 20px;">
                <center><label>Souhaitez Vous Supprimer Cet Aministrateur: <?php echo $show['supplier_fname'].' '.$show['supplier_lname'];?>?</label><br>
                <input type="text" hidden="" value="<?php echo $show['supplierID'];?>" name="deletefrom">
