                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd"><br class="hidden-xs hidden-sm"><br class="hidden-xs hidden-sm">
                                <div class="main-sparkline13-hd">
                                    <h1>All <span class="table-project-n">Administrators</span> <small><strong class="pull-right text-success">
                                        <?php
                                        $datasess=array();
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo $show['admin_phone'];?></td>
                                                <td><?php echo $show['admin_city'];?></td>
                                                <td><?php echo $show['country_name'];?></td>
                                                <td><?php if($show['admin_status']==0) echo 'Desactivated'; else echo 'Activated';?></td>
                                                <td>
                            <a href="" class="glyphicon glyphicon-pencil text-primary" data-toggle="modal" <?php  echo 'data-target="#edit'.$show['adminID'].'ers"'; ?>></a>  
                             <a href="" class="glyphicon glyphicon-remove text-danger" data-toggle="modal" <?php  echo 'data-target="#remove'.$show['adminID'].'ers"'; ?>></a>
                          </td>
                                            </tr>
...
<div class="modal fade"  <?php  echo 'id="remove'.$show['adminID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!--edit the selected field-->
     ...
     <div class="modal fade"  <?php  echo 'id="edit'.$show['adminID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="post" action="../../class/adminControl.php" class="form-group" style="shape-margin: 20px;">
                ...
                <div class="form-group">
                  <input type="text" name="fname" value="<?php echo $show['admin_fname'];?>" class="form-control col-xs-6">
                </div><br><br><br>
                <div class="form-group">
                  <input type="text" name="lname" value="<?php echo $show['admin_lname'];?>" class="form-control col-xs-6">
                </div><br><br>
                <div class="form-group">
                  <input type="email" name="email" value="<?php echo $show['admin_email'];?>" class="form-control col-xs-6">
                </div><br><br>
                <div class="form-group">
                  <input type="text" name="phone"  value="<?php echo $show['admin_phone'];?>" data-inputmask="'mask' : '(999) 999-999-999'" class="form-control col-xs-6">
                </div><br><br>
               <div class="form-group">
                  <input type="text" name="address" value="<?php echo $show['admin_city'];?>" class="form-control col-xs-6">
              </div><br><br>
              <div class="form-group">
                  <select  name="status"  class="form-control col-xs-6">
                    <option hidden="" value="<?php echo $show['admin_status'];?>"><?php if($show['admin_status']==0) echo 'Desactivated'; else if($show['admin_status']==1) echo 'Activated';?></option>
