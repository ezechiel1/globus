                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="../../class/CategoryController.php" method="POST" style="padding-bottom: 20%;">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="addCategory">Save</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
