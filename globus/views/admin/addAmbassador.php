                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1>New Ambassador<small><strong  class="pull-right text-success">
                                        <?php
                                            $sessData=array();
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="../../class/AmbassadorsController.php" method="POST">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="addAmbassadors">Register</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
