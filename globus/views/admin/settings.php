                            ...
                            <div class="sparkline12-hd">
                             <div class="sparkline12-graph">
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        <div class="col-md-12" id="set">
                                            <div class="all-form-element-inner">
                                                <form action="../../class/addAgent_Controller.php" method="POST" class="setf">
                                                 <div class="setting-form">
                                                    <div class="col-md-5">
                                                         <div class="file-upld">
                                                            <center>
                                                                <div class="img">
                                                                 <img src="../../img/logo/th.png">
                                                                </div>
                                                            </center>
                                                    ...
                                                    <div class="btn-sub">
                                                        <a class="btn btn-default" name="submit">Change</a>
                                                    </div>
                                                    </div>
                                                    </div>
