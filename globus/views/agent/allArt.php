                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd"><br class="hidden-xs hidden-sm"><br class="hidden-xs hidden-sm">
                                <div class="main-sparkline13-hd">
                                    <h1>All <span class="table-project-n">Art Products</span><small><strong  class="pull-right text-success">
                                        <?php
                                            $sessData=array();
...
$allproduct=$db->getRows($tblName,$condition);
//check if there are available data
if(!empty($allproduct)):
    $count = 0; 
    foreach($allproduct as $show): 
        $count++; 
