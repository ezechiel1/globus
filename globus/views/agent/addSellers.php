                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd"></br></br>     
                                    <h1>New Seller <small><strong class="pull-right text-success">
                                    <?php
                                    $sessData=array();
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form action="../../class/SellersController.php" method="POST">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" data-mask="999-999-999-999" required="" class="form-control" placeholder=""  name="Telephone" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                   <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select name="Status" required="" class="form-control col-md-7 col-xs-12" placeholder="Enter the mobile number">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <input class="btn btn-sm btn-primary login-submit-cs" type="submit" name="AddSellers" value="Register">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
