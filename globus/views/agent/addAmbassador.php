...
<head>
    ...
    <title>Advance Form Element | jeweler - Material Admin Template</title>
                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1>New Agent <small><strong  class="pull-right text-success">
                                        <?php
                                            $sessData=array();
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="../../class/addAmbassadors_Controller.php" method="POST">
                                                    ...
                                                    <div class="form-group-inner">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <select name="status" required="required"  class="form-control col-lg-9 col-md-7 col-xs-12">
                                                                ...
                                                                <option value="2" name="Status">Desactive</option>
                                                            </select>
                                                        </div>    
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="addAmbassadors">Save</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
