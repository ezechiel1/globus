...
if(isset($_POST['addProduct']))
{
  ...
  $code=$_SESSION['type'];
            ...
            //set redirect url
                if($code==1): $redirectURL .= 'admin/addFournitures.php'; 
                elseif($code==2): $redirectURL .= 'ambassador/addFournitures.php';
                elseif($code==3): $redirectURL .= 'agent/addFournitures.php';
                endif;
                else:
     ...
     $tblName = 'fourniture_product';
      $code=$_SESSION['type'];
            ...
            if($update){
                ...
                $sessData['status']['msg'] = 'Operation done successfully ';
             //set redirect url
            if($code==1): $redirectURL .= 'admin/allFournitures.php'; 
            elseif($code==2):$redirectURL .= 'ambassador/allFournitures.php';
            elseif($code==3):$redirectURL .= 'agent/allFournitures.php';
            endif;
