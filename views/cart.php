             ...
             <!-- <tr>
                <td>
                  <div class="product-item"><a class="product-thumb" href="shop-single.php"><img src="../img/shop/cart/02.jpg" alt="Product"></a>
                    <div class="product-info">
                      <h4 class="product-title"><a href="shop-single.php">Daily Fabric Cap</a></h4><span><em>Size:</em> XL</span><span><em>Color:</em> Black</span>
                    </div>
                  </div>
                </td>
                <td class="text-center">
              ...
              <tr>
                <td>
                  <div class="product-item"><a class="product-thumb" href="shop-single.php"><img src="../img/shop/cart/03.jpg" alt="Product"></a>
                    <div class="product-info">
                      <h4 class="product-title"><a href="shop-single.php">Cole Haan Crossbody</a></h4><span><em>Size:</em> -</span><span><em>Color:</em> Turquoise</span>
                    </div>
                  </div>
                </td>
                <td class="text-center">
        ...
        <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: true, &quot;margin&quot;: 30, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;576&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;991&quot;:{&quot;items&quot;:4},&quot;1200&quot;:{&quot;items&quot;:4}} }">
          ...
          <div class="grid-item">
            <div class="product-card">
              <div class="product-badge text-danger">22% Off</div><a class="product-thumb" href="../views/product-description.php"><img src="../img/shop/products/09.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Rocket Dog</a></h3>
          ...
          <div class="grid-item">
            <div class="product-card">
                ...
                </div><a class="product-thumb" href="../views/product-description.php"><img src="../img/shop/products/03.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Oakley Kickback</a></h3>
          ...
          <!-- Product-->
          <div class="grid-item">
            <div class="product-card"><a class="product-thumb" href="../views/product-description.php"><img src="../img/shop/products/12.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Vented Straw Fedora</a></h3>
          ...
          <div class="grid-item">
            <div class="product-card">
                ...
                </div><a class="product-thumb" href="../views/product-description.php"><img src="../img/shop/products/11.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Top-Sider Fathom</a></h3>
          ...
          <div class="grid-item">
            <div class="product-card"><a class="product-thumb" href="shop-single.html"><img src="../img/shop/products/04.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Waist Leather Belt</a></h3>
          ...
          <div class="grid-item">
            <div class="product-card">
              <div class="product-badge text-danger">50% Off</div><a class="product-thumb" href="../views/product-description.php"><img src="../img/shop/products/01.jpg" alt="Product"></a>
              <h3 class="product-title"><a href="../views/product-description.php">Unionbay Park</a></h3>
              <h4 class="product-price">
                <del>$99.99</del>$49.99
              </h4>
              <div class="product-buttons">
...
<!-- Mirrored from themes.rokaux.com/unishop/v3.0/template-1/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2019 09:17:15 GMT -->
</html>