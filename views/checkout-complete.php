...
<!-- Mirrored from themes.rokaux.com/unishop/v3.0/template-1/checkout-complete.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2019 09:19:50 GMT -->
<head>
    <meta charset="utf-8">
    <title>Checkout
    </title>
      ...
      <nav class="offcanvas-menu">
        <ul class="menu">
          <li class="has-children"><span><a href="index.php"><span>Home</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                <li><a href="index.php">Featured Products Slider</a></li>
                <li><a href="home-featured-categories.php">Featured Categories</a></li>
                <li><a href="home-collection-showcase.php">Products Collection Showcase</a></li>
            </ul>
          </li>
          <li class="has-children active"><span><a href="shop-grid-ls.php"><span>Shop</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                <li><a href="shop-categories.php">Shop Categories</a></li>
              <li class="has-children"><span><a href="shop-grid-ls.php"><span>Shop Grid</span></a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
              ...
              <li class="has-children"><span><a href="shop-list-ls.php"><span>Shop List</span></a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
          ...
          <li class="has-children"><span><a href="account-orders.php"><span>Account</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                ...
                <li><a href="account-open-ticket.php">Open Ticket</a></li>
                <li><a href="account-tickets.php">My Tickets</a></li>
                <li><a href="account-single-ticket.php">Single Ticket</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="blog-rs.php"><span>Blog</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li class="has-children"><span><a href="blog-rs.php"><span>Blog Layout</span></a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
              ...
              <li class="has-children"><span><a href="blog-single-rs.php"><span>Single Post Layout</span></a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
          ...
          <li class="has-children"><span><a href="#"><span>Pages</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                ...
                <li><a href="mobile-app.php">Unishop Mobile App</a></li>
          ...
          <li class="has-children"><span><a href="components/accordion.php"><span>Components</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
      ...
      <nav class="site-menu">
        <ul>
          <li class="has-megamenu"><a href="index.php"><span>Home</span></a>
            <ul class="mega-menu">
              <li><a class="d-block img-thumbnail text-center navi-link" href="index.php"><img alt="Featured Products Slider" src="img/mega-menu-home/01.jpg">
                  <h6 class="mt-3">Featured Products Slider</h6></a></li>
              <li><a class="d-block img-thumbnail text-center navi-link" href="home-featured-categories.php"><img alt="Featured Categories" src="img/mega-menu-home/02.jpg">
                  <h6 class="mt-3">Featured Categories</h6></a></li>
              <li><a class="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.php"><img alt="Products Collection Showcase" src="img/mega-menu-home/03.jpg">
          ...
          <li class="active"><a href="shop-grid-ls.php"><span>Shop</span></a>
            <ul class="sub-menu">
                <li><a href="shop-categories.php">Shop Categories</a></li>
              ...
              <li class="has-children"><a href="shop-list-ls.php"><span>Shop List</span></a>
                ...
                <li><a href="shop-single.php">Single Product</a></li>
                <li><a href="cart.php">Cart</a></li>
              <li class="active has-children"><a href="checkout-address.php"><span>Checkout</span></a>
                <ul class="sub-menu">             
                    ...
                    <li class="active"><a href="checkout-complete.php">Complete</a></li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li><a href="account-orders.php"><span>Account</span></a>
            <ul class="sub-menu">
                <li><a href="account-login.php">Login / Register</a></li>
                <li><a href="account-password-recovery.php">Password Recovery</a></li>
                <li><a href="account-orders.php">Orders List</a></li>
          ...
          <li><a href="blog-rs.php"><span>Blog</span></a>
            <ul class="sub-menu">
      ...
      <div class="container padding-bottom-3x mb-2">
        <div class="card text-center">
          <div class="card-body padding-top-2x">
            ...
            <div class="padding-top-1x padding-bottom-1x"><a class="btn btn-outline-secondary" href="shop-grid-ls.php">Go Back Shopping</a><a class="btn btn-outline-primary" href="order-tracking.php"><i class="icon-location"></i>&nbsp;Track order</a></div>
          </div>
        </div>
      </div>
      <!-- Site Footer-->
